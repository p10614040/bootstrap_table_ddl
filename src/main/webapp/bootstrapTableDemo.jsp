...
<body>
	...
	<!-- 查询条件 -->
	<div id="bsTableToolbar">
        <div class="form-inline" role="form">
            <div class="form-group">
                <span>产品类型: </span>
                <select class="form-control w70" name="type" id="type">
			         <option>1</option>
			         <option>2</option>
			         <option>3</option>
			         <option>4</option>
	...
	<script src="javascript/common/bsTable/bsTableDefault.js"></script>
	<script src="javascript/common/bsTable/bsTableFormatter.js"></script>

	
	<script src="javascript/app/bootstrapTableDemo/bootstrapTableDemo.js"></script>
</body>
</html>